...
class Physics:
    """Класс для физических расчетов - единая точка управления физикой"""
    ...
    def resolve_ball_collision(b1, b2):
        """Разрешение столкновения двух шаров (упругое соударение)"""
        dx = b2.x - b1.x
        dy = b2.y - b1.y
        ...
        if distance < min_dist and distance > 0:
            ...
            if vrel_dot_n < 0:
                # Коэффициент упругости (почти абсолютно упругий удар)
                e = 0.95
    ...
    def calculate_shoot_direction(start_pos, end_pos):
        """Расчет направления и силы удара по позициям мыши"""
